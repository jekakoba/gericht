...
***************************************************************************** */
        ...
        if (animItems.length > 0) {
            ...
            function animOnScroll(params) {
                for (let index = 0; index < animItems.length; index++) {
                    ...
                    if (scrollY > animItemOffset - animItemPoint && scrollY < animItemOffset + animItemHeight) animItem.classList.add("_active-anim"); else if (!animItem.classList.contains("_anim-no-hide")) animItem.classList.remove("_active-anim");
                }
            }
            function offset(el) {
        ...
        window.addEventListener("load", (function(e) {
            ...
            window.addEventListener("scroll", (function(e) {
                window.scrollY > window.innerHeight / 1 ? goTop.classList.add("back-to-top-show") : goTop.classList.remove("back-to-top-show");
            }));
        }));
        window["FLS"] = false;
        isWebp();
